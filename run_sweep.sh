...
export AGENTDOJO_LOCAL_MODEL="${LOCAL_MODEL:-qwen3.8:27b}"
export AGENTDOJO_LOCAL_BASE_URL="${LOCAL_BASE_URL:-http://10.251.36.222:11434/v1}"
...
export SECAGENT_POLICY_BASE_URL="${SECAGENT_POLICY_BASE_URL:-${LOCAL_BASE_URL:-http://10.251.36.222:11434/v1}}"
